...
public class InterfazCliente extends javax.swing.JFrame implements Observer {
    ...
    public InterfazCliente() {
        ...
        this.tamprimo =parseInt(JOptionPane.showInputDialog(null, "Escriba el tamaño del primo:"));
        initComponents();
        this.getRootPane().setDefaultButton(this.btnEnviar);
        generarPrimos(tamprimo);
        generarClaves(tamprimo);
        obtenerIP();
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(4, 5));
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        this.txtTexto.append("Mensaje: " +  this.txtTextoEnviar.getText() + "\n\n");
